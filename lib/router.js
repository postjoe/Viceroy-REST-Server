...
Router.prototype.resource = function(resourceUrl, opts, subRouteLoader) {
  ...
  opts = opts || {};
  opts.controller = opts.controller || resourceUrl;
  ...
  this._contextIdToken = this._getSubIdToken(resourceName);

  // set the resource name context
  if(this._resourceContext.length > 0) {
    var lastResourceContext = this._resourceContext[this._resourceContext.length - 1];
    lastResourceContext.idToken = lastContextIdToken;
  }
...
Router.prototype._bind = function(method, routeUrl, opts, subRouteLoader) {
  ...
  var fullUrl = this._urisToUrl(this._context) + this._urisToUrl(uris);
  ...
  this._routes[fullUrl][method] = {
    ...
    context: this._resourceContext.slice(0)
  };
