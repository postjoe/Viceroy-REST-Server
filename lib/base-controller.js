...
exports.fetchConextModel = function(models, params, context, callback) {
  var getModelbyContext = function(currentContext, callback) {
    ...
    var id = params[currentContext.idToken];
    var query = {};
    if(id) { query._id = id; }
...
exports.index = function(models, req, res, next) {
  ...
  if(req.context.length > 0) {
    this.fetchConextModel(models, req.params, req.context, function(err, model) {
